...
# take in raw data
data_orionon = np.loadtxt('orionavgon')
data_orionoff = np.loadtxt('orionavgoff')
diff = data_orionon - data_orionoff

# make complex numpy array with data
complex_data_orionon = np.empty(16000, dtype=complex)
complex_data_orionon.real = data_orionon[:16000]
complex_data_orionon.imag = data_orionon[16000:]

# compute fourier transform
fourier_orionon = np.fft.fft(complex_data_orionon)
# sample rate is 62.5e6 Hz, spacing is inverse
sample_spacing = 1.9200012288007864325e-7
fourier_axis_orionon = np.fft.fftfreq(n=len(complex_data_orionon), d=sample_spacing)
# fourier filter
fourier_orionon[0] = 0
...
# make complex numpy array with data
complex_data_orionoff = np.empty(16000, dtype=complex)
complex_data_orionoff.real = data_orionoff[:16000]
complex_data_orionoff.imag = data_orionoff[16000:]

# compute fourier transform
fourier_orionoff = np.fft.fft(complex_data_orionon)
# sample rate is 62.5e6 Hz, spacing is inverse
sample_spacing = 1.9200012288007864325e-7
fourier_axis_orionoff = np.fft.fftfreq(n=len(complex_data_orionoff), d=sample_spacing)
# fourier filter
fourier_orionoff[0] = 0
